      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              >
                <div className="space-y-2">
                  ...
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl py-8">
                    Transforming HR with the Power of AI
                  </h2>
                  <Link
                    to="/ai-for-hr-checklist"
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              >
                ...
                <p className="text-muted-foreground md:text-xl mb-4">
                  HR is one of AI's best early adopters —{" "}
                  <a
                    href="https://www.gartner.com/en/human-resources/topics/artificial-intelligence-in-hr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-semibold hover:underline"
                  >
                    81% of HR leaders say they're already exploring or using AI
                  </a>
                  .
                  <br /> But the flood of vendors and quickly changing
                  information lead to AI rollouts that eventually cause buyer's
                  remorse, disenchanted end users, and wasted time for your
                  team.
                  <br /> Here's what savvy HR leaders already know: AI isn't
                  just about technology—it's about people.
                </p>
                <p className="text-muted-foreground md:text-xl mb-4">
                  The key to successful AI adoption lies in recognizing the
                  human factors at play and addressing the needs, concerns, and
                  aspirations of your workforce.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
          ...
          <div className="container px-4 md:px-6 mx-auto max-w-7xl">
            <div className="grid gap-6 lg:grid-cols-[400px_1fr] lg:gap-12 xl:grid-cols-[600px_1fr]">
              ...
              >
                ...
                <p className="text-muted-foreground md:text-xl mb-4">
                  Our mission is to provide a different path toward successful
                  AI adoption where your team and employees are empowered and
                  supported.{" "}
                  <strong>
                    We blend practical AI Engineering know-how with Workplace
                    Psychology insights to accelerate AI adoption in your
                    workforce.
                  </strong>
                </p>
                <p className="text-muted-foreground md:text-xl mb-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground md:text-xl mb-8">
                  <li>
                    <strong>Research-Based Frameworks</strong>
                    <br />
                    We created an HR-centered framework for AI adoption that is
                    grounded in behavioral science and real-world research. This
                    framework simplifies how to balance your organization's AI
                    readiness, culture, and task-tech fit to create an effective
                    and compassionate AI strategy.
                  </li>
                  <li>
                    <strong>
                      Psychological, Social, and Emotional Resistance to Tech
                    </strong>
                    <br />
                    We help HR leaders and their teams identify practical AI use
                    cases and develop functional prototypes. Our approach is
                    unique in that we use hands-on demonstrations to address
                    fears and boost confidence, overcoming mental, social, and
                    emotional friction points. When handled correctly, teams see
                    AI as an ally in their work.
                  </li>
                  <li>
                    <strong>Scalable Solutions</strong>
                    <br />
                    We've designed our consulting guidance, tools, and
                    frameworks to help you scale. We don't leave you with access
                    to new tools or systems without a plan for how they will
                    provide high-impact, high-margin results that grow with your
                    organization.
                  </li>
                </ul>
              </motion.div>
        ...
        >
          <div className="container px-6 md:px-8 mx-auto max-w-7xl">
            ...
            >
              We not only help you identify high-value use cases for your team
              and business, our team has spent over two decades (combined)
              advising HR leaders and creating bespoke software solutions.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              className="text-muted-foreground md:text-xl mb-8"
            >
              Unlike other AI consultancies that take a technology-only approach
              to process and workflow transformation, we understand the
              challenges to successful AI adoption from an HR perspective (and
              have hands-on experience solving them).
            </motion.p>
          </div>
        </motion.section>
        ...
        >
          <div className="container px-4 md:px-6 mx-auto max-w-7xl">
            ...
            <motion.p
              ...
              className="text-muted-foreground md:text-xl mb-8"
            >
              These are just a few examples of the HR problems we have solved
              and how we can integrate AI:
            </motion.p>
        ...
        >
          <div className="container px-4 md:px-6 mx-auto max-w-7xl text-center">
            ...
            <motion.p
              ...
              className="text-muted-foreground md:text-xl mb-8"
            >
              Sign up for our newsletter to stay up to date on future courses
              and the best of AI for HR.
            </motion.p>
          </div>
        </motion.section>
      </main>
